        ...
        <div className="container" style={{position:"relative",zIndex:1}}>
          ...
          <div className="price-card">
            ...
            <ul className="price-list">
              ...
              <li><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12l5 5L20 7"/></svg><span><b>Print-ready QR tag PDF</b> — download, cut, attach</span></li>
              <li><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12l5 5L20 7"/></svg><span><b>Found Pet button</b> with GPS &amp; SMS alerts</span></li>
